...
import itrafgen.gui.packetdescriptor.HexEditor.JHexEditor;
...
public class Creator extends JFrame {
    ...
    private Hashtable a = new Hashtable<Integer,byte[]>();
	/**
	...
	private void initialize() {
		this.setSize(756, 363);
		this.setContentPane(getJContentPane());
		this.setTitle("Paramètres du paquet reçu");
	...
	private JButton getJButton2() {
	 ...
	 private static int sum(byte[] bb) {
			...
			new AlertBox(getFrames()[getFrames().length - 1],"Header Checksum",Integer.toHexString(sum));
			return sum;
		    }
	/**
	...
	private JButton getJButton3() {
		if (jButton3 == null) {
			...
			jButton3.setBounds(new Rectangle(659, 300, 75, 29));
			jButton3.setText("OK");
